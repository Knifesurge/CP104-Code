...
def set_trials(subjects):
    ...
    for subject in subjects[:subjects_middle]:
        drugs.append(subject)
        del subjects[0]
    
    for subject in range(len(subjects)):
        placebos.append(subjects[0])
        del subjects[0]
